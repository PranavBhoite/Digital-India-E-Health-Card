...
/**
 * Servlet implementation class DisplayServletDr
 */
@WebServlet("/DisplayServletDr")
public class DisplayServletDr extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayServletDr() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(str.equals("AddDiseaseDr")){
				System.out.println("IN ADD disease displayservlet");
				RegisterDao rd=new RegisterDao();
				Registrationbean r=rd.DisplayUser(username_op);
				request.setAttribute("Current_User_Obj",r);
				request.getRequestDispatcher("adddiseaseDr.jsp").forward(request, response);
			}
