...
/**
 * Servlet implementation class AddDiseaseDrController
 */

@MultipartConfig
@WebServlet("/AddDiseaseDrController")
public class AddDiseaseDrController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddDiseaseDrController() {
        super();
