...
<body style="font-size: 30px;">
	...
	<%
		...
		String n="Health ID:   "+    reg.getHealthid() +"  "+"Name: "+" "+reg.getRegFname()+"  "+reg.getRegMname()+"  "+reg.getRegLname()+"   "+ "Allergies: "+mib.getAllergies()+"blood group: "+mib.getBg()+"Blood pressure: "+mib.getBp()+"Height: "+mib.getHeight()+"Weight: "+mib.getWeight();
				;
	%>
