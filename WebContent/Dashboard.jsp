...
<body>
	...
	<div class="sidenav">
		...
		<form action="DisplayServlet" method="get" align="center">
			...
			<Button name="operation" value="contact" id="b">
				<a href="http://localhost:8501/" target="_blank">Disease Prediction</a>
			</Button>
			
			<Button name="operation" value="contact" id="b">
				<a href="http://localhost:8502/" target="_blank">Patient Psychology Prediction</a>
			</Button>
			
			<Button name="operation" value="contact" id="b">
				<a href="http://localhost:8503/" target="_blank">Medicine Adherence Tracker</a>
			</Button>
