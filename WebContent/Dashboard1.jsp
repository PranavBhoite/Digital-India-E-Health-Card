...
<body>
	...
	<%
		...
		session.setAttribute("Usernm", currentUser.getHealthid());
	...
	<div class="sidenav">
		...
		<form action="DisplayServletDr" method="get" align="center">
			<center>
				...
				<h5>
					User Account:&nbsp;&nbsp; <input type="text" value="<%= currentUser.getHealthid() %>"
			...
			<Button name="operation" value="UpdateMedicalInfo" id="b" onClick="JavaScript:window.location='addmedicalinfo.jsp';">
				<a href = "addmedicalinfoDr.jsp">Update Medical Information</a>
			</Button>
			<hr>
			<Button name="operation" value="AddDiseaseDr" id="b">
			<a href = "adddiseaseDr.jsp">	Add New Infected Disease </a>
			</Button>
		</form>
	</div>
	<div class="topwelcome">
		...
		<div
			style="background: url(https://img.freepik.com/free-vector/medical-technology-science-background-vector-blue-with-blank-space_53876-117739.jpg)"
			...
			<div class="welcome" style="padding-left: 120px;">
				...
				<div class="container py-5">
					...
					<h1 class="display-4 font-weight-bold mb-4">
						WELCOME TO HEALTH-CARD-ID.IN OF<br>
