...
<body onload="generateQRCode();">
	...
	<%
		...
		session.setAttribute("Usernm", reg.getHealthid());
	...
	<div class="fullbody" id="divToPrint">
		...
		<table border="1" width=100% height=20% id="t01"
			...
			<tr style="text-align: center">
				...
				<td style="padding: 10px;">  <form action="AddReportImage" method="get">
    <button class="button-29" role="button" type="submit">Fetch Image</button>
</form>                               </td>
			</tr>
			<%} %>
