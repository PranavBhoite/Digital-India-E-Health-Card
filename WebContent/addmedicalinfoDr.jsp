...
<%!boolean o = false;%>
	...
	<div class="page-wrapper bg-dark p-t-100 p-b-50"
		style="background: url('images//bg1.gif'); background-attachment: fixed; background-repeat: no-repeat; height: auto; background-size: cover; background-position: center;">
		...
		<div class="wrapper wrapper--w900">
			<div class="card card-6">
				...
				<div class="card-body" style="color: black;">
					<form action = "AddMedicalInfoControllerDr" method="get" style="color: #000;">
						<div class="form-row">
