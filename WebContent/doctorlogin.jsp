...
<div class="entirebody">
        ...
        <div class="topnav" id="myTopnav">
			...
			<a href="doctorregistration.jsp">Doctor Register</a> 
        ...
        <div class="login-box" style="position: absolute; top: 26%; left: 54%; transform: translate(-74%, -44%);">
        <form action="AddDoctorLogin">
        <img src="images//ava.jpg" class="avatar">
        <h1>Login Here</h1>

        <p>Enter Medical License No.</p>
        <input type="text" name="license" id="username" placeholder="Medical License No.">
        <p>Enter Password</p>
        <input type="password" name="password" id="myInput" placeholder="Enter Password">
        <input type="checkbox" onclick="ShowPassword()">
        <p>Show Password</p>
        <button type="submit" value="submit" width="10%" style="width: 100%; border: none; outline: none; height: 40px; background: #1c8adb; color: #fff; font-size: 18px; border-radius: 20px;">Login</button>
           <a href="#">Forget Password</a> &nbsp;&nbsp;&nbsp; New here? <a href="registration.jsp">Sign up</a> <br>
       </form>
     </div>
